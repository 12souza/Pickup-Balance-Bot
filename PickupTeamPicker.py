...
async def a(ctx, name):
    ...
    if(ctx.message.channel.name == 'outhouse-pickups'):    
        if(pickupActive == 1):   
            if(name not in list(rTotalPlayers)):    
                
                row = findPlayerRow(str(name))
                playerName = sheet.cell(row, 2).value
        ...
        if(pickupActive == 1):
            if(len(rTotalPlayers) % 2 == 0):
                ...
                while(teamsPicked == 0): 
                    ...
                    totalPlayerSum = 0
                    counter += 1
                await ctx.send("Blue: " + str(blueRank))
                await ctx.send("Red: " + str(redRank))
                print(redTeam)
                print(blueTeam)   
                ...
                bEnumList = list(enumerate(blueTeam, start = 1))
                for i in range(len(bEnumList)):
                    bMsgList.append("  " + str(bEnumList[i][0]) + " " * (3 - len(str(bEnumList[i][0]))) + "│ " + bEnumList[i][1] + (" " * (27 - len(bEnumList[i][1]))) + "│ " + str(rTotalPlayers[bEnumList[i][1]]) + "\n")
                bMsg = ''.join(bMsgList)

                rMsgList =  ['     │     Player Name            │\n', '-----╪----------------------------╪--\n']
                rEnumList = list(enumerate(redTeam, start = 1))
                for i in range(len(rEnumList)):
                    rMsgList.append("  " + str(rEnumList[i][0]) + " " * (3 - len(str(rEnumList[i][0]))) + "│ " + rEnumList[i][1] + (" " * (27 - len(rEnumList[i][1]))) + "│ " + str(rTotalPlayers[rEnumList[i][1]]) + "\n")
                rMsg = ''.join(rMsgList)
            ...
            if(len(rTotalPlayers) % 2 == 0):
                ...
                while(teamsPicked == 0):    
                    for i in list(rTotalPlayers):
                        rTotalPlayers[i] = int(rTotalPlayers[i])
                    print(rTotalPlayers)
                    sortedPlayers = sorted(rTotalPlayers, key=rTotalPlayers.get, reverse=True)
                    sortedplayers = list(sortedPlayers)
                    if(teamCount == 3):
                        blueTeam.append(sortedPlayers[0])
                        blueTeam.append(sortedPlayers[2])
                        blueTeam.append(sortedPlayers[5])
                        redTeam.append(sortedPlayers[1])
                        redTeam.append(sortedPlayers[3])
                        redTeam.append(sortedPlayers[4])
                    elif(teamCount == 4):
                        blueTeam.append(sortedPlayers[0])
                        blueTeam.append(sortedPlayers[2])
                        blueTeam.append(sortedPlayers[4])
                        blueTeam.append(sortedPlayers[7])
                        redTeam.append(sortedPlayers[1])
                        redTeam.append(sortedPlayers[3])
                        redTeam.append(sortedPlayers[5])
                        redTeam.append(sortedPlayers[6])
                    elif(teamCount == 5):
                        blueTeam.append(sortedPlayers[0])
                        blueTeam.append(sortedPlayers[2])
                        blueTeam.append(sortedPlayers[4])
                        blueTeam.append(sortedPlayers[7])
                        blueTeam.append(sortedPlayers[8])
                        redTeam.append(sortedPlayers[1])
                        redTeam.append(sortedPlayers[3])
                        redTeam.append(sortedPlayers[5])
                        redTeam.append(sortedPlayers[6])
                        redTeam.append(sortedPlayers[9])
                    elif(teamCount == 6):
                        blueTeam.append(sortedPlayers[0])
                        blueTeam.append(sortedPlayers[2])
                        blueTeam.append(sortedPlayers[4])
                        blueTeam.append(sortedPlayers[6])
                        blueTeam.append(sortedPlayers[9])
                        blueTeam.append(sortedPlayers[10])
                        redTeam.append(sortedPlayers[1])
                        redTeam.append(sortedPlayers[3])
                        redTeam.append(sortedPlayers[5])
                        redTeam.append(sortedPlayers[7])
                        redTeam.append(sortedPlayers[8])
                        redTeam.append(sortedPlayers[11])
                    elif(teamCount == 7):
                        blueTeam.append(sortedPlayers[0])
                        blueTeam.append(sortedPlayers[2])
                        blueTeam.append(sortedPlayers[4])
                        blueTeam.append(sortedPlayers[7])
                        blueTeam.append(sortedPlayers[8])
                        blueTeam.append(sortedPlayers[11])
                        blueTeam.append(sortedPlayers[12])
                        redTeam.append(sortedPlayers[1])
                        redTeam.append(sortedPlayers[3])
                        redTeam.append(sortedPlayers[5])
                        redTeam.append(sortedPlayers[6])
                        redTeam.append(sortedPlayers[9])
                        redTeam.append(sortedPlayers[10])
                        redTeam.append(sortedPlayers[13])
                    elif(teamCount == 8):
                        blueTeam.append(sortedPlayers[0])
                        blueTeam.append(sortedPlayers[2])
                        blueTeam.append(sortedPlayers[4])
                        ...
                        blueTeam.append(sortedPlayers[11])
                        blueTeam.append(sortedPlayers[12])
                        blueTeam.append(sortedPlayers[15])
                        redTeam.append(sortedPlayers[1])
                        redTeam.append(sortedPlayers[3])
                        redTeam.append(sortedPlayers[5])
                        redTeam.append(sortedPlayers[6])
                        ...
                        redTeam.append(sortedPlayers[10])
                        redTeam.append(sortedPlayers[13])
                        redTeam.append(sortedPlayers[14])
                    elif(teamCount == 9):
                        blueTeam.append(sortedPlayers[0])
                        blueTeam.append(sortedPlayers[2])
                        blueTeam.append(sortedPlayers[4])
                        ...
                        blueTeam.append(sortedPlayers[12])
                        blueTeam.append(sortedPlayers[15])
                        blueTeam.append(sortedPlayers[17])
                        redTeam.append(sortedPlayers[1])
                        redTeam.append(sortedPlayers[3])
                        redTeam.append(sortedPlayers[5])
                        redTeam.append(sortedPlayers[6])
                        ...
                        redTeam.append(sortedPlayers[13])
                        redTeam.append(sortedPlayers[14])
                        redTeam.append(sortedPlayers[16])
                    else:
                        pass
                    teamsPicked = 1
                print(list(sortedPlayers))
...
client.run('NzMyMzcyMTcwMzY5NTMxOTc4.XwzovA.ngNtyusstc8Oz_xV2pM1BH_JZ70')
